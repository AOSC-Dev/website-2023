...
const livkitPPlacement = ['top', 'left', 'bottom'];
  ...
  <div class="pl-[1px] flex flex-col min-w-[1148px] ss">
      ...
      >
        ...
        <div class="text-aosc-os my-[2rem]">
          ...
          <p class="width-[220px] text-[10pt]">
            {{ getAntongDate() }}·
            <AccordionNavigation
              :navigationList="aoscOsNavigationList"
              linkClass=""
              >·</AccordionNavigation
            >
          </p>
          ...
          <div v-loading="loading">
            ...
            >
              <DownloadButton
                ...
                :key="item.title"
                @myClick="downloadIso(item.installer.path)"
    ...
    <div class="livekit-container w-[100%] flex flex-row">
      <div class="flex flex-col">
        <div
          id="livekit-title"
          class="flex-col my-auto pl-[2rem] py-[1rem] flex"
        >
          ...
          <p class="mt-1">
            <AccordionNavigation
              :navigationList="liveKitNavigationList"
              linkClass=""
              >·</AccordionNavigation
            >
          </p>
          ...
          >
            <span v-for="(item, index) in antong1List" :key="item.title">
              <DownloadButton
                :popoverData="{
                  ...item.popoverData,
                  placement: livkitPPlacement[index],
                }"
                :secondLineFontSize="8"
                :width="200"
                :firstLineFontSize="10"
                :archName="item.zhLabel"
    ...
    <div class="wsl-container w-[100%] flex flex-row">
      <div class="flex flex-col pl-[2rem] py-[1rem]">
        ...
        <p id="wsl-description" class="mt-2 text-[16pt]">
          Windows 与安同双双联手，生产力触手可及
        </p>
        <p class="mt-1">
          <AccordionNavigation :navigationList="wslNavigationList" linkClass=""
            >·</AccordionNavigation
          >
        </p>
      </div>
    ...
    >
      <div id="oma-title" class="pl-[2rem] my-auto">
        ...
        <p class="mt-1">
          <AccordionNavigation :navigationList="omaNavigationList" linkClass=""
            >·</AccordionNavigation
          >
        </p>
      </div>
