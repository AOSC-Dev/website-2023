  ...
  <div class="pl-[1px]">
    ...
    <div class="p-6">
      <p>
        ...
        使用经验的用户，针对个人桌面设备优化体验，致力于为用户提供开箱即用和简便可靠的工作环境。
      </p>
      <br />
      <div>
      ...
      <div ref="bgImg">
        <img
          src="/assets/aosc-os/aosc-os.zh-cn.webp"
    ...
    <div ref="features" class="p-6">
      ...
      <p
        >以开箱即用作为主要设计目标，安同 OS
        是您日常工作的得力助手。从文字办公到服务器运维，摄影后期到 3D
        建模，课堂笔记到文档翻译，我们的系统助您快速部署、高效工作、尽情创作。</p
      >
      <app-h2>易于管理</app-h2>
      <p
        >从安装到系统更新，从组件管理到日常维护，安同 OS
        内建许多易于使用的管理工具，助您轻松管理、舒心使用。例如安同 OS
        内建的小熊猫包管理 (oma)
        ，其简明且人性化的界面让系统管理尽可能低风险、低耗时、高可靠。</p
      >
      <!--
      <app-h2>省心可靠</app-h2>
      ...
      <p
        ...
        等跨发行版生态，扩充软件支持的范畴；此外，Spiral 兼容性标记可提供 Debian
        及 Ubuntu 软件包兼容性。</p
      >
      <app-h2>随处可用</app-h2>
      <p
        >基于灵活性极高的 Linux 内核构建，安同 OS
        支持台式机、笔记本、单片机和服务器等多种类型、基于各类主流处理器架构的设备，且为各类使用场景调优，助您发挥各类设备的潜力。</p
      >
      <app-h2>如影随形</app-h2>
      <p
