...
<template>
  <div class="pl-[1px]">
    ...
    <div class="p-6">
      <p>
        安同 OS
        支持多种处理器架构，本表介绍支持的各类处理器架构及相应的微架构指令集扩展支持、软件包架构名及编译器目标名等信息。本表分为一级架构、二级架构和实验性架构三组，对应不同支持和维护水平。 </p
      ><br />
    </div>
    <div id="aoscOsIsaTableTitle">
      <category-second
        title="一级架构"
        id="aoscOsIsaTableTitle1" />
    </div>
    <div class="p-6">
      <p>
        一级架构包含安同 OS
    ...
    <div class="p-6">
      ...
      <p>
        *: 这一系列处理器包括龙芯 3A1000,
        ...
        3B1000, 3B1500, 3B2000, 3B3000, 3B4000
        等型号；型号为 5000 或更高的均为基于龙架构
        (LoongArch) 的处理器
      </p>
    </div>
