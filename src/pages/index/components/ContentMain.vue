...
import {
  onMounted, reactive, ref, useTemplateRef, onUnmounted,
} from 'vue';
import { ElIcon } from 'element-plus';
import CategorySecond from '@/components/CategorySecond.vue';
import NewsCategoryList from '@/pages/news/components/NewsCategoryList.vue';
...
(async () => {
  const [res, err] = await requestGetJson('/newsCategories/home.zh-cn.json');
  if (res) {
...
<template>
  <div class="w-[62.5%] bg-content-main-bg p-0">
    <a
      :style="{ '--homepage-img-height1': imgHeight }"
      ref="bgImg"
      href="/aoscos"
