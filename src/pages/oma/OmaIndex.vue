...
<template>
  <div class="pl-[1px]">
    ...
    <div class="p-6">
      <p>
        小熊猫包管理 (oma) 是一款为使用
        <AppLink to="https://wiki.debian.org/Teams/Dpkg">dpkg</AppLink>
        的发行版设计的软件包管理前端，也是<AppLink to="/aosc-os"
          >安同 OS</AppLink
        >
      ...
      <div class="px-16 pt-4 pb-4">
        <ul class="list-disc">
          <li
            ...
            包管理工具的同时，让界面指引、报错及操作逻辑更为简洁易懂</li
          >
          <li
            ><b>增强防呆机制：</b
            >通过清晰的指引和操作撤销等机制，助您避免因粗心或其他原因造成系统故障，进而浪费时间和精力</li
          >
          <li
            ><b>优化网络性能：</b>使用 HTTP/2
            和多线程下载等技术，大幅度加快软件包安装与更新</li
          >
          <li
            ><b>提升使用效率：</b>结合 CLI（命令行）和
            TUI（终端窗体）界面，让您的系统管理体验更轻松明晰</li
          >
          <li
            ><b>集成系统功能：</b>与安同 OS
            的测试源和镜像源数据等机制集成，提供一站式的系统组件管理体验</li
          >
          <li
            ><b>兼容主流系统：</b>支持 Debian、Ubuntu 和 deepin 等主流 dpkg
            发行版，让软件包管理更易用</li
          >
        </ul>
      </div>
