...
hljs.registerLanguage('erlang_repl', erlang_repl)
...
hljs.registerLanguage('jboss_cli', jboss_cli)
hljs.registerLanguage('json', json)
hljs.registerLanguage('julia', julia)
hljs.registerLanguage('julia_repl', julia_repl)
...
hljs.registerLanguage('node_repl', node_repl)
...
hljs.registerLanguage('python_repl', python_repl)
