...
<template>
  <div class="pl-[1px]">
    ...
    <category-second id="design" title="设计理念" />
    <div class="p-6">
      ...
      <div class="pt-4 pb-2 px-16">
        <ul class="list-disc">
          ...
          <li>对开源和闭源软件一视同仁。</li>
          <li>重视系统可靠性。</li>
          <li>在不同架构上提供相近的功能和体验。</li>
        </ul>
      </div>
    </div>
    <category-second id="pros" title="安同 OS 的主要优点" />
    <div class="p-6">
      <p>安同 OS 主要优点如下：</p>
      <div class="pt-4 pb-2 px-16">
        <ul class="list-disc">
          ...
          <li>硬件驱动支持完整。</li>
          <li>电源管理配置开箱即用。</li>
          <li>预装针对特定地区的网络连通工具。</li>
          <li>通过 Wine 提供良好的 Windows 应用支持。</li>
          <li>各架构体验统一且优化充分。</li>
        </ul>
      </div>
    </div>
    <category-second id="cons" title="安同 OS 的主要缺点" />
    <div class="p-6">
      ...
      <div class="pt-4 pb-2 px-16">
        <ul class="list-disc">
          ...
          <li>软件仓库的规模较小。</li>
          <li>对第三方商业软件支持有限。</li>
          <li>维护者人手有限，软件修复和安全更新响应较慢。</li>
          <li>预装闭源和非自由软件。</li>
        </ul>
      </div>
    </div>
    <category-second id="recommended-usage" title="适用场景" />
    <div class="p-6">
      <p>适用本系统的场景如下：</p>
      <div class="pt-4 pb-2 px-16">
        <ul class="list-disc">
    ...
    <category-second id="discouraged-usage" title="不适用场景" />
    <div class="p-6">
      ...
      <div class="pt-4 pb-2 px-16">
        <ul class="list-disc">
          ...
          <li>对软件更新的响应速度要求较高。</li>
          <li>商用或有高可靠性需求的环境。</li>
          <li>公有云或虚拟服务器等存储成本较高的环境。</li>
          <li>对非自由软件敏感。</li>
        </ul>
      </div>
    </div>
