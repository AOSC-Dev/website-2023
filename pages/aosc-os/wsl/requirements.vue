  ...
  <div>
    ...
    <div class="p-6">
      <p>
        ...
        系统组件版本等均有一定的需求。根据我们的测试，我们总结出了如下以使用体验良好为基本基准的系统配置需求表。
      </p>
      <table class="mt-6" ref="aoscOsRequirementsList">
        ...
        <tbody>
          <tr>
            <td>处理器</td>
            <td
              >处理器需支持 x86-64（如 Intel 64 或 AMD64）指令集、Intel VT 或
              AMD-V 等 VMM 特性、XD 位或 NX 位、以及 SLAT</td
            >
          </tr>
          <tr>
            <td>系统组件</td>
            <td
              >Windows 10, Version 1607 及以上（如需使用 WSLg
              运行图形化应用程序，则需要 Windows 10, Version 2004 及以上或
              Windows 11）</td
            >
          </tr>
          <tr>
            <td>显示</td>
            <td
              >WSLg 兼容的 GPU 驱动程序（使用 WSLg 运行图形化、OpenGL
              加速的应用程序时）</td
            >
          </tr>
          <tr>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>系统组件</td>
            <td
              >Windows 10, Version 1709 及以上（如需使用 WSLg
              运行图形化应用程序，则需要 Windows 10, Version 2004 及以上或
              Windows 11）</td
            >
          </tr>
          <tr>
            <td>显示</td>
            <td
              >Windows 兼容的 GPU 驱动程序（使用 WSLg 运行图形化、OpenGL
              加速的应用程序时）</td
            >
          </tr>
          <tr>
    ...
    <div class="pt-4 pb-4 px-16">
      <ul class="list-disc">
        ...
        >
        <li
          >在虚拟机中运行 WSL 版安同 OS (AOSC OS on WSL)
          时需开启嵌套虚拟化支持</li
        >
        <li
          >AOSC OS 绝大部分应用程序假设良好的 VT 支持，推荐使用最新版 Windows
          Terminal 而非 Windows Console（前者需要 Windows 10, Version 2004
          及以上）</li
        >
        <li>WSL 2 中的 systemd 支持需要 0.67.6 或更新版本的 WSL 组件</li>
        <li
          >推荐使用最新的操作系统、WSL 及 Windows Terminal
          版本，开发人员可能无法对不受微软支持版本软件中存在的兼容性问题提供协助</li
        >
        <li
        ...
        <li
          >安同
          OS通过互联网获取更新，请确保互联网连接畅通以便及时获得系统更新</li
        >
      </ul>
    </div>
    <br />
